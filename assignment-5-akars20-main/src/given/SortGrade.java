...
public class SortGrade<K extends Comparable<K>> {
  ...
  // public static HashMap<String, ArrayList<String>> multiTestCompSwap = new
  ...
  public static void main(String[] args) throws NoSuchMethodException, SecurityException {
    ...
    String[] algsToGrade = { "isort", "qsort", "tsort", "hsort", "csort" };
    int dataLengths[] = { 50, 256, 1000, 10000 };

    // Type of data to test, look at the pdf for descriptions
    String runTypes[] = { "uniform", "randomizedDuplicates", "staggered", "sortedChunks", "constant", "sorted",
        "ladder", "sortedReverse" };

    QuickSort<Integer> qsort = new QuickSort<Integer>();
    TimSort<Integer> tsort = new TimSort<Integer>();
    ...
    System.arraycopy(dataTmp, 0, dataTmp2, 0, numData);
    tsort.sort(dataTmp2);
    boolean tsorted = integerGrader.isSorted(dataTmp2);
    ...
    // Testing timsort merge, 10 points
    ...
    for (String type : runTypes) {
      try {
        ...
        tsort.merge(data, 0, data1.length - 1, data.length - 1);
        ...
        if (merged) {
          ...
          Autograder.Log("Array not merged with timsort merge. Data Type: " + type);
      } catch (Exception e) {
    ...
    for (String alg : algsToGrade) {
      switch (alg) {
        ...
        case "qsort":
          ...
          break;
        case "tsort":
          algToGrade = new TimSort<Integer>();
          break;
        case "hsort":
    ...
    for (String alg : algsToGrade) {
      switch (alg) {
        ...
        case "qsort":
          ...
          break;
        case "tsort":
          algToGradeD = new TimSort<Double>();
          break;
        case "hsort":
    ...
    for (String alg : algsToGrade) {
      switch (alg) {
        ...
        case "qsort":
          ...
          break;
        case "tsort":
          algToGradeS = new TimSort<String>();
          break;
        case "hsort":
